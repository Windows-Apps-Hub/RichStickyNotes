...
{
    internal static NoteData CreateNewDefault() => new() { Cells = { new GRTKCell( ) } };
...
[JsonSourceGenerationOptions(WriteIndented = true, GenerationMode = JsonSourceGenerationMode.Serialization)]
[JsonDerivedType(typeof(GRTKCell), typeDiscriminator: nameof(GRTKCell))]
public class NoteCellBase
{

}
[JsonSourceGenerationOptions(WriteIndented = true, GenerationMode = JsonSourceGenerationMode.Serialization)]
public class GRTKCell : NoteCellBase
{
